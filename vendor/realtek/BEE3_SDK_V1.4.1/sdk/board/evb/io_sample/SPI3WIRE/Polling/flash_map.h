...
example:
    ...
    3) OTA Bank0:                                    444K (0x00802000)
        a) OTA Header                    4K (0x00802000)
        b) Secure boot loader            4K (0x0080D000)
        c) Patch code                   40K (0x00803000)
        d) Upperstack  Code            144K (0x0080E000)
        e) APP code                    252K (0x00832000)
        f) APP data1                     0K (0x00871000)
        g) APP data2                     0K (0x00871000)
        h) APP data3                     0K (0x00871000)
        i) APP data4                     0K (0x00871000)
        j) APP data5                     0K (0x00871000)
        k) APP data6                     0K (0x00871000)
    4) OTA Bank1:                                      0K (0x00871000)
    ...
    5) FTL:                                           16K (0x00871000)
    6) OTA Tmp:                                       40K (0x00875000)
    7) APP Defined Section:                            0K (0x0087F000)
*/
...
#define OTA_BANK0_SIZE                  0x0006F000  //444K Bytes
#define OTA_BANK1_ADDR                  0x00871000
#define OTA_BANK1_SIZE                  0x00000000  //0K Bytes
#define FTL_ADDR                        0x00871000
#define FTL_SIZE                        0x00004000  //16K Bytes
#define OTA_TMP_ADDR                    0x00875000
#define OTA_TMP_SIZE                    0x0000A000  //40K Bytes
...
#define BANK0_APP_SIZE                  0x0003F000  //252K Bytes
#define BANK0_APP_DATA1_ADDR            0x00871000
#define BANK0_APP_DATA1_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA2_ADDR            0x00871000
#define BANK0_APP_DATA2_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA3_ADDR            0x00871000
#define BANK0_APP_DATA3_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA4_ADDR            0x00871000
#define BANK0_APP_DATA4_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA5_ADDR            0x00871000
#define BANK0_APP_DATA5_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA6_ADDR            0x00871000
