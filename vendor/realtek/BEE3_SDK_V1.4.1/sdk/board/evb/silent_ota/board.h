...
#define ENABLE_BANK_SWITCH_COPY_APP_DATA            0
#define ENABLE_SLAVE_REQUEST_UPDATE_COON_PARA       0
#define FLASH_256M_TEST                             0 //256Mbit flash test

#define SUPPORT_OTA_PROTOCOL_TYPE_CHARACTERISTIC    0  //silent ota add update conn para procedure
