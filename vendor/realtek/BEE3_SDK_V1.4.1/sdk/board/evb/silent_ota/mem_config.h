...
/** @brief Set data ram to shut down, SHUTDOWN_DATARAM_SIZE must be: 4KB/8KB/24KB/56KB) */
...
#define HEAP_DATA_ON_SIZE              (59 * 1024 - APP_GLOBAL_SIZE - UPPERSTACK_GLOBAL_SIZE - SHUTDOWN_DATARAM_SIZE)
