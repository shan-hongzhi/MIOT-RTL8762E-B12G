...
#define HARDFAULT_RECORD_BEG_ADDR                 (0x00880000 - 0x3000)  //change to user unused space
...
#define REBOOT_REASON_RECORD_ADDRESS                  (0x00880000 - 0x1000)
...
#define USER_DATA_START_ADDR                       (0x00800000 + 8 * 1024 * 1024)  //back 8M
#define USER_DATA_MAX_SIZE                         (8 * 1024 * 1024)  //8M
