...
//        {
//            APP_PRINT_INFO0("[keyscan_init_driver] KeyScan_Manual_Sel_Bit");
//        }
//        else
//        {
//            APP_PRINT_INFO0("[keyscan_init_driver] KeyScan_Manual_Sel_Key");
//        }
    }
...
void keyscan_interrupt_handler(void)
{
    ...
    else
    {
        ...
        keyscan_init_data();
        /* start key trigger keyscan manual mode */
        keyscan_init_driver(KeyScan_Manual_Sel_Key, KeyScan_Debounce_Enable);
        return;
    }
}
...
void keyscan_timer_callback(void *pxTimer)
{
    ...
    /* start register trigger keyscan manual mode */
