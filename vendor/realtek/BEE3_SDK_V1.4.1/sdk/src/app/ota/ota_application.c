...
* @brief     normal ota application implementation
* @details   normal ota application implementation
* @author
* @date
* @version
* *********************************************************************************************************
        ...
        case SERVICE_CALLBACK_TYPE_READ_CHAR_VALUE:
            {
                ...
                APP_PRINT_INFO2("Battery Level: g_bat_vol=%d , g_bas_battery_level=%d", g_bat_vol,
                                g_bas_battery_level);
