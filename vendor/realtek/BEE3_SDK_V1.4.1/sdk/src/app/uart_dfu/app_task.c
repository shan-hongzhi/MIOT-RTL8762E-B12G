 ...
 *============================================================================*/
static void app_main_task(void *p_param) DATA_RAM_FUNCTION;
bool app_send_msg_to_app(T_IO_MSG *p_msg) DATA_RAM_FUNCTION;
 ...
 */
bool app_send_msg_to_app(T_IO_MSG *p_msg)
{
