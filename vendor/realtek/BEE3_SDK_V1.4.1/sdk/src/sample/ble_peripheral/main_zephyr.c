...
void main_zephyr(void)
{
    DBG_DIRECT("main zephyr");
    extern void schedule_created_thread(void);
    schedule_created_thread();
}
/**
...
int main(void)
{
    ...
    extern void mem_data_copy(void);
    mem_data_copy();
