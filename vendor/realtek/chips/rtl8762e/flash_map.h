...
example:
	...
	3) OTA Bank0:                                    276K (0x00802000)
		a) OTA Header                    4K (0x00802000)
		b) Secure boot loader            4K (0x0080D000)
		c) Patch code                   40K (0x00803000)
		d) Upperstack  Code              0K (0x0080E000)
		e) APP code                    228K (0x0080E000)
		f) APP data1                     0K (0x00847000)
		g) APP data2                     0K (0x00847000)
		h) APP data3                     0K (0x00847000)
		i) APP data4                     0K (0x00847000)
		j) APP data5                     0K (0x00847000)
		k) APP data6                     0K (0x00847000)
	4) OTA Bank1:                                      0K (0x00847000)
	...
	5) FTL:                                            0K (0x00847000)
	6) OTA Tmp:                                      200K (0x00847000)
	7) APP Defined Section:                           12K (0x00879000)
*/
...
#define OTA_BANK0_SIZE                  0x00045000  //276K Bytes
#define OTA_BANK1_ADDR                  0x00847000
#define OTA_BANK1_SIZE                  0x00000000  //0K Bytes
#define FTL_ADDR                        0x00847000
#define FTL_SIZE                        0x00000000  //0K Bytes
#define OTA_TMP_ADDR                    0x00847000
#define OTA_TMP_SIZE                    0x00032000  //200K Bytes
#define BKP_DATA1_ADDR                  0x00879000
...
#define BANK0_APP_SIZE                  0x00039000  //228K Bytes
#define BANK0_APP_DATA1_ADDR            0x00847000
#define BANK0_APP_DATA1_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA2_ADDR            0x00847000
#define BANK0_APP_DATA2_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA3_ADDR            0x00847000
#define BANK0_APP_DATA3_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA4_ADDR            0x00847000
#define BANK0_APP_DATA4_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA5_ADDR            0x00847000
#define BANK0_APP_DATA5_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA6_ADDR            0x00847000
