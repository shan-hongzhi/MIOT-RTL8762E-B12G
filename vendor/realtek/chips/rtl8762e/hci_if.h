...
#define HCI_RX_ACL_PKT_BUF_OFFSET 19
#define HCI_TX_ACL_PKT_BUF_OFFSET 11

#define HCI_RX_ISO_PKT_BUF_OFFSET 19
#define HCI_TX_ISO_PKT_BUF_OFFSET 11
...
bool hci_if_check_msg_queue(void);
