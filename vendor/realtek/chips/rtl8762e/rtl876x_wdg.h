...
extern APP_CB_WDG_RESET_TYPE __rtl_app_cb_wdg_reset;
...
/**
   ...
   */
extern void __RTL_WDG_ClockEnable(void);
...
/**
   ...
   * @retval none.
   */
extern void __RTL_WDG_Config(uint16_t div_factor, uint8_t cnt_limit, T_WDG_MODE wdg_mode);

/**
   * @brief  Watch Dog Timer Enable.
     NOTE: When call __RTL_WDG_Disable() before entering dlps, must call __RTL_WDG_Config() before __RTL_WDG_Enable() when exiting dlps!
   */
extern void __RTL_WDG_Enable(void);

/**
   * @brief  Watch Dog Timer Disable.
   */
extern void __RTL_WDG_Disable(void);

/**
   * @brief  Watch Dog Timer Restart.
   */
extern void __RTL_WDG_Restart(void);
...
/**
   ...
   *                   3: reset all
   */
extern void __RTL_WDG_SystemReset(T_WDG_MODE wdg_mode, T_SW_RESET_REASON reset_reason);


extern T_SW_RESET_REASON  __rtl_reset_reason_get(void);
