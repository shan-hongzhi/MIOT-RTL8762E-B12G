...
typedef struct otp_struct
{
    ...
    uint8_t wdgConfigCntLimit : 4;            /* refer to __RTL_WDG_Config(), default = 15 */
...
extern void (*__RTL_SystemInit)(void);
extern void __RTL_LogUartDMAIdleHook(void);
extern void __rtl_init_osc_sdm_timer(void);
extern void __rtl_low_stack_init(void);
extern uint32_t __rtl_ota_header_addr;
