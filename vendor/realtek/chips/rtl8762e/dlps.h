...
extern void __rtl_platform_pm_set_power_mode(PlatformPowerMode pf_power_mode_user);
extern PlatformPowerMode __rtl_platform_pm_get_power_mode(void);
extern void __rtl_btmac_pm_set_power_mode(BtmacPowerMode bz_power_mode_user);
extern void __rtl_power_manager_suspend_all(void);
extern void __rtl_power_manager_resume_all(void);
extern void __rtl_platform_pm_register_callback_func(void *cb_func, PlatformPMStage pf_pm_stage);
extern void __rtl_platform_pm_get_statistics(uint32_t *wakeup_count, uint32_t *last_wakeup_clk,
                                       uint32_t *last_sleep_clk);
extern void __rtl_btmac_pm_get_statistics(uint32_t *wakeup_count, uint32_t *last_wakeup_clk,
                                    uint32_t *last_sleep_clk);
extern void __rtl_platform_pm_stop_all_non_excluded_timer(void);

extern PlatformPowerModeErrorCode __rtl_platform_pm_get_error_code(void);
extern uint32_t *__rtl_platform_pm_get_refuse_reason(void);
extern PlatformWakeupReason __rtl_platform_pm_get_wakeup_reason(void);

extern BtmacPowerModeErrorCode __rtl_btmac_pm_get_error_code(void);
extern BtmacWakeupReason __rtl_btmac_pm_get_wakeup_reason(void);
...
{
    __rtl_platform_pm_register_callback_func(func, PLATFORM_PM_CHECK);
    return true;
}
...
{
    __rtl_platform_pm_register_callback_func(func, dlpsState);
    return true;
}
...
{
    __rtl_power_manager_suspend_all();
}
...
{
    __rtl_power_manager_resume_all();
}
...
static inline void lps_mode_set(PlatformPowerMode mode)
{
    ...
    __rtl_platform_pm_set_power_mode(mode);
}
...
{
    return __rtl_platform_pm_get_power_mode();
}
...
static inline  uint32_t lps_wakeup_count_get(void)
{
    ...
    __rtl_platform_pm_get_statistics(&wakeup_count, &last_wakeup_clk, &last_sleep_clk);
    return wakeup_count;
}
...
struct dlps_driver_ops {
  bool (*check_cb)(uint32_t *timeout);
  void (*enter_dlps_cb)(void);
  void (*exit_dlps_cb)(void);
  void (*weakup_cb)(void);
};
...
{
    __RTL_SystemCall(SYSTEM_CALL_ENTER_POWERDOWN_DIRECTLY, 0);
}

extern void __rtl_power_manager_init(void);
extern void __rtl_platform_pm_init(void);
extern void __rtl_bt_pm_register(void);
extern void (*__rtl_platform_pm_enter)(void);
extern void (*__rtl_platform_pm_restore_os_tick_count)(void);
