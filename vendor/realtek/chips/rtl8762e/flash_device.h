 ...
 * @return none
*/
extern void __rtl_flash_dump_flash_info(void);
...
*/
extern uint32_t __rtl_flash_get_bank_addr(T_FLASH_LAYOUT_NAME name);
...
*/
extern uint32_t __rtl_flash_get_bank_size(T_FLASH_LAYOUT_NAME name);
...
*/
extern uint32_t __rtl_flash_ioctl(uint32_t cmd, uint32_t param_1, uint32_t param_2);
 ...
 * @return flash_exists
*/
extern T_FLASH_EXIST_LV __rtl_flash_get_flash_exist(void);
...
*/
extern bool __rtl_flash_erase_locked(T_ERASE_TYPE type, uint32_t addr);
 ...
 * @retval false   fail to access flash because other flash access is not finished
*/
extern bool __rtl_flash_write_locked(uint32_t start_addr, uint32_t data_len, const uint8_t *data);
...
*/
extern bool __rtl_flash_auto_write_locked(uint32_t start_addr, uint32_t data);
...
*/
extern bool __rtl_flash_auto_write_buffer_locked(uint32_t start_addr, uint32_t *data, uint32_t len);
...
*/
extern bool __rtl_flash_read_locked(uint32_t start_addr, uint32_t data_len, uint8_t *data);
 ...
 * @retval false fail to access flash because other flash access is not finished
*/
extern bool __rtl_flash_auto_read_locked(uint32_t addr, uint32_t *data);
 ...
 *       recommand to use auto read other than this api
*/
extern bool __rtl_flash_split_read_locked(uint32_t start_addr, uint32_t data_len, uint8_t *data,
                                    uint32_t *counter);
...
*/
extern bool __rtl_flash_auto_dma_read_locked(T_FLASH_DMA_TYPE dma_type, FlashCB flash_cb,
...
*/
extern bool __rtl_flash_auto_seq_trans_dma_read_locked(T_FLASH_DMA_TYPE dma_type, FlashCB flash_cb,
                                                 uint32_t src_addr, uint32_t dst_addr, uint32_t data_len);
...
*/
extern bool __rtl_flash_get_bit(uint32_t flag, uint32_t bit);
...
*/
extern bool __rtl_flash_get_block_protect_locked(uint8_t *bp_lv);
...
* @return   success or not
*/
extern bool __rtl_flash_set_block_protect_locked(uint8_t bp_lv);
...
* @return   success or not
*/
extern bool __rtl_flash_sw_protect_unlock_by_addr_locked(uint32_t unlock_addr, uint8_t *old_bp_lv);
 ...
 * @retval others1 fail
  */
extern T_FLASH_RET __rtl_flash_try_high_speed(T_FLASH_MODE bit_mode);
