...
extern uint32_t __rtl_platform_random(uint32_t max);
 ...
 * @return none
 */
extern volatile void (*__rtl_platform_delay_ms)(uint32_t t);
 ...
 * @return none
 */
extern volatile void (*__rtl_platform_delay_us)(uint32_t t);
