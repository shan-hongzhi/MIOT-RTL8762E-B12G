...
typedef bool (*APP_MAIN_FUNC)(void);
typedef void (*USER_CALL_BACK)(void);
...
/** @defgroup SYSTEM_RTL876X_Exported_Variables System RTL876X Exported Variables
    ...
    * @{
    */
extern APP_MAIN_FUNC __rtl_upperstack_entry;
extern APP_MAIN_FUNC __rtl_app_pre_main;
extern APP_MAIN_FUNC __rtl_app_main;
 ...
 */
extern bool __RTL_RamVectorTableInit(uint32_t ram_vector_addr);
 ...
 * @retval FALSE Fail
 */
extern bool __RTL_RamVectorTableUpdate(VECTORn_Type v_num, IRQ_Fun isr_handler);
 ...
 * @return none
 */
extern void __RTL_SystemCall(uint32_t opcode, uint32_t parm);
 ...
 * @return none
 */
extern void __rtl_update_ram_layout(uint32_t app_global_size, uint32_t data_heap_size,
...
extern void __rtl_hal_setup_hardware(void);
extern void __rtl_hal_setup_cpu(void);
extern void __RTL_LogUartTxChar(int);
