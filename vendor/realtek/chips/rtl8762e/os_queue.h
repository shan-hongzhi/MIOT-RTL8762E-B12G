 ...
 *     __rtl_os_queue_init(&test_queue);
 * }
 * \endcode
 *
 * \ingroup  Queue
 */
void  __rtl_os_queue_init(T_OS_QUEUE *p_queue);
 ...
 *
 *     // Enqueue the item.
 *     __rtl_os_queue_in(&test_queue, &a_item);
 * }
 * \endcode
 *
 * \ingroup  Queue
 */
void  __rtl_os_queue_in(T_OS_QUEUE *p_queue, void *p_elem);
 ...
 *     p_item = __rtl_os_queue_out(&test_queue);
 * }
 * \endcode
 *
 * \ingroup  Queue
 */
void *__rtl_os_queue_out(T_OS_QUEUE *p_queue);
 ...
 *     p_item = __rtl_os_queue_peek(&test_queue);
 * }
 * \endcode
 *
 * \ingroup  Queue
 */
void *__rtl_os_queue_peek(T_OS_QUEUE *p_queue);
 ...
 *
 *     // Enqueue the item 1.
 *     __rtl_os_queue_in(&test_queue, &item1);
 *
 *     // Enqueue the item 2.
 *     __rtl_os_queue_in(&test_queue, &item2);
 *
 *     // Insert the item 3 behind item 1 but before item 2.
 *     __rtl_os_queue_insert(&test_queue, &item1, &item3);
 * }
 * \endcode
 *
 * \ingroup  Queue
 */
void  __rtl_os_queue_insert(T_OS_QUEUE *p_queue, void *p_elem, void *p_new_elem);
 ...
 *
 *     // Enqueue the item 3.
 *     __rtl_os_queue_in(&test_queue, &item3);
 *
 *     // Then delete the item 2.
 *     __rtl_os_queue_delete(&test_queue, &item12);
 * }
 * \endcode
 *
 * \ingroup  Queue
 */
bool  __rtl_os_queue_delete(T_OS_QUEUE *p_queue, void *p_elem);
