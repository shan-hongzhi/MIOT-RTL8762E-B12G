...
#define BT_MESH_KEY_PATH          0xfedf
...
#define BT_MESH_APP_SEG_SDU_MAX   ((CONFIG_BT_BUF_EVT_DISCARDABLE_SIZE - 26 - 13) -\
                                    2 - 4 - 9 - 4)
#else
...
#if defined(CONFIG_BT_MESH_EXT_ADV)
#define BT_MESH_APP_UNSEG_SDU_MAX ((CONFIG_BT_BUF_EVT_DISCARDABLE_SIZE - 26 - 13) -\
                                    2 - 4 - 9 - 1)
#else
